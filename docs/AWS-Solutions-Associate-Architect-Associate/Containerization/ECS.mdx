...
- [EFS](../Storage/EFS.mdx) is used as persistent multi-AZ shared storage for ECS tasks
...
This will allow the ECS cluster to run Docker containers (ECS tasks) on these instances.
    - ![attachments/Pasted image 20220509230845.jpg](./img/ecs-1.jpg)
...
- VPC and ECS cluster are setup the same way as in EC2 launch type, but instead of using [ASG](../Computing/EC2/Auto-Scaling-Groups.mdx)
...
attach an ENI (private IP) to each task. So, if we have a lot of ECS tasks, **we need sufficient free private IPs**.
    - ![attachments/Pasted image 20220509231345.jpg](./img/ecs-2.jpg)
...
- Diagram
    - ![attachments/Pasted image 20220509232531.jpg](./img/ecs-3.jpg)

## Load Balancing
---------------------------------------------------

- **EC2 Launch Type**
    - For every container, the container port is mapped to a random free port on the hots (instance). So the application running inside that container will be reached by the ALB on that random port. ![attachments/Pasted image 20230215182905.jpg](./img/ecs-4.jpg)
    ...
    - Diagram
        - ![attachments/Pasted image 20220509232914.jpg](./img/ecs-5.jpg)
- **Fargate Launch Type**
    ...
    - Diagram
        - ![attachments/Pasted image 20220509233226.jpg](./img/ecs-6.jpg)
...
- Min: 50% and Max: 100% and starting number of tasks 4
    - ![attachments/Pasted image 20220509234001.jpg](./img/ecs-7.jpg)
- Min: 100% and Max: 150% and starting number of tasks 4
    - ![attachments/Pasted image 20220509234016.jpg](./img/ecs-8.jpg)
