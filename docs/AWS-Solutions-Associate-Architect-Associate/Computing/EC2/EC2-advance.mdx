...
- <Tag title='h2'>Cluster Placement Group (optimize for network)</Tag>
...
- <Tag title='h2'>Spread Placement Group (maximize availability)</Tag>
...
- <Tag title='h2'>Partition Placement Group (balance of performance and availability)</Tag>
...
## Storage
 - [Instance Store](../../Storage/instance_store.mdx)
 - [Elastic Block Storage- EBS](../../Storage/EBS.mdx)
 - [Elastic File Storage- EFS](../../Storage/EFS.mdx)

## Monitoring
 - [Cloud Watch => EC2 Monitoring](../../MonitoringAudit/CloudWatch.mdx#ec2-monitoring)
