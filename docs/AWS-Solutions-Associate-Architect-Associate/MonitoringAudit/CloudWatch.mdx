...
*   Logs from multiple accounts and regions can be aggregated using subscription filters
    *   ![attachments/Pasted image 20220510222924.jpg](./img/metric.jpg)
...
*   **Composite Alarms** monitor multiple other alarms with AND/OR conditions to generate a new alarm.
This is helpful to reduce alarm noise by creating complex composite alarms.
    Example: send an SNS notification when both CPU and IOPS are above 90% utilization. ![attachments/Pasted image 20230219094745.jpg](./img/Logs.jpg)
