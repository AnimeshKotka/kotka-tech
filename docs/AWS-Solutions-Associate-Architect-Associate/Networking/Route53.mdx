...
## Route 53
- Global Service
- AWS managed Authoritative DNS (customer can update the DNS records and have full control over the [DNS](/docs/AWS-Solutions-Associate-Architect-Associate/Concepts#dns))
