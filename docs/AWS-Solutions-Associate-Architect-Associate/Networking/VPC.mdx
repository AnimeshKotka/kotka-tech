...
*   Way to define a range of IP addresses
    *   ![attachments/Pasted image 20220512094258.jpg](./images/ip-addrs.jpg)
*   Two parts
    *   Base IP - 192.168.0.0
...
*   Allows resources in a VPC to connect to the Internet
    *   ![attachments/Pasted image 20220512100002.jpg](./images/ig-1.jpg)
*   **Attached to the VPC**
...
*   Route table of the public subnets must be edited to allow requests destined outside the VPC to be routed to the IGW
    *   ![attachments/Pasted image 20220512222218.jpg](./images/ig-2.jpg)
...
*   A EC2 instance running in the public subnet (accessible from public internet), to allow users to SSH into the instances in the private subnet.
    *   ![attachments/Pasted image 20220512100455.jpg](./images/boston.jpg)
...
*   Disadvantages
    ...
    *   You must manage [Security Groups](../Computing/EC2/EC2.mdx#security-groups) & rules:
        *   Inbound:
...
*   Architecture
    *   ![attachments/Pasted image 20220512101803.jpg](./images/nat-2.jpg)
...
*   Route Tables for private subnets must be configured to route internet-destined traffic to the NAT gateway
    *   ![attachments/Pasted image 20220512222148.jpg](./images/nat-gateway-1.jpg)
*   No Security Groups to manage
*   Pay per hour
*   Architecture
    *   ![attachments/Pasted image 20220512204306.jpg](./images/nat-gateway-2.jpg)
*   High Availability
    ...
    *   ![attachments/Pasted image 20220512204520.jpg](./images/nate-gateway-3.jpg)
...
*   Two settings need to be enabled to allow DNS resolution within a VPC:
    *   **DNS Support** (enableDnsSupport)
        ...
        *   Diagram
            *   ![attachments/Pasted image 20220512210247.jpg](./images/Pasted%20image%2020220512210247.jpg)
...
*   If you use custom domain names in a Private Hosted Zone in Route 53, you must enable both of these settings
    *   ![attachments/Pasted image 20220512210613.jpg](./images/Pasted%20image%2020220512210613.jpg)
...
*   **Default NACL allows all inbound & outbound requests**
    *   ![attachments/Pasted image 20220512215745.jpg](./images/Pasted%20image%2020220512215745.jpg)
*   NACL Rules
...
*   NACL vs [Security Group](../Computing/EC2/EC2.mdx#security-groups)
    *   NACL
    ...
    *   ![attachments/Pasted image 20220512220220.jpg](./images/Pasted%20image%2020220512220220.jpg)
*   NACL with Ephemeral Ports
    ...
    *   ![attachments/Pasted image 20220512220647.jpg](./images/Pasted%20image%2020220512220647.jpg)

## VPC Peering
---------------------------------------------

*   Connect two VPCs (could be in **different region or account**) using the AWS private network
    *   ![attachments/Pasted image 20220512221728.jpg](./images/Pasted%20image%2020220512221728.jpg)
...
*   Must update route tables in each VPC’s subnets to ensure requests destined to the peered VPC can be routed through the peering connection
    *   ![attachments/Pasted image 20220512221946.jpg](./images/Pasted%20image%2020220512221946.jpg)
    *   ![attachments/Pasted image 20220512221954.jpg](./images/Pasted%20image%2020220512221954.jpg)
...
*   **Private endpoints** within your VPC that allow AWS services to privately connect to resources within your VPC without traversing the public internet (cheaper)
    *   ![attachments/Pasted image 20220512222517.jpg](./images/Pasted%20image%2020220512222517.jpg)
...
*   Enable IPv6 to operate in **dual-stack mode** in which your EC2 instances will get at least a **private IPv4** and a **public IPv6**. They can communicate using either IPv4 or IPv6 to the internet through an Internet Gateway.
    *   ![attachments/Pasted image 20220513005218.jpg](./images/Pasted%20image%2020220513005218.jpg)
...
*   Allows instances in your VPC to initiate outbound connections over IPv6 while preventing inbound IPv6 connections to your private instances.
    *   ![attachments/Pasted image 20220513005755.jpg](./images/Pasted%20image%2020220513005755.jpg)
*   Similar to [NAT Gateway](./VPC.mdx#nat-gateway) but for IPv6
