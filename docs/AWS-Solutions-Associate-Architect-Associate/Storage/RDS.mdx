...
- EC2 instances & Lambda functions should access the DB using <Tag color="#FF5733">IAM DB Authentication (AWSAuthenticationPlugin with IAM)</Tag> - token based access
