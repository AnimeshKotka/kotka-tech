...
<Tag color="#d97706">This prevents application downtime or request failures during patching.</Tag>  
...
<Tag color="#2563eb">This gives you fine-grained control over patching, with zero disruption to traffic.</Tag>
